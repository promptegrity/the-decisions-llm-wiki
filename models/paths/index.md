...
Common situations as **ordered model sequences**. Use when the user describes a life/work problem, not a model name.

Return to [Decision jobs](/index.md) or [models hub](/models/index.md). For a single entry model, see [routing](/models/routing.md).
